...
public class Product implements Serializable {
    ...
    @Column(columnDefinition = "TEXT") // Maior que varchar, aceita textos longos
    ...
    @JoinTable(name = "tb_product_category", //Referencia a tabela associativa
            joinColumns = @JoinColumn(name = "product_id"), //Pega pelo campo da entidade atual
            inverseJoinColumns = @JoinColumn(name = "category_id")) //Pega pelo campo da entidade da coleção anotada
